...
| `pptx-presentation-builder` | 브랜드 정렬 레이아웃의 전문 PPTX 프레젠테이션 빌더 (피치·로드맵·제품 덱) | All platforms |
...
> 전체 77개 동시 주입 (~22,400 tokens)은 금지. Tier 1 + 온디맨드 max 3개 원칙으로 5% 이하 컨텍스트 비용 유지.
